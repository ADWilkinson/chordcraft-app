...
const colors = {
  ...
  zinc:
    'bg-zinc-500/15 text-zinc-700 group-data-hover:bg-zinc-500/25 dark:text-zinc-400 dark:group-data-hover:bg-zinc-500/20',
  zincDark: 'bg-zinc-600/10 text-zinc-700 group-data-hover:bg-zinc-600/20 dark:bg-white/5 dark:text-zinc-400 dark:group-data-hover:bg-white/10',
}
