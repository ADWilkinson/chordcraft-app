...
const base = [
  ...
  'before:absolute before:inset-0 before:-z-10 before:rounded-[calc(0.3125rem-1px)] before:bg-white before:shadow-xs',
  ...
  'dark:group-data-disabled:border-white/20 dark:group-data-disabled:bg-white/[2.5%] dark:group-data-disabled:[--checkbox-check:var(--color-white)]/50 dark:group-data-disabled:group-data-checked:after:hidden',
  // Forced colors mode
...
const colors = {
  ...
  zinc: '[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-zinc-700)] [--checkbox-checked-border:var(--color-zinc-800)]/90',
