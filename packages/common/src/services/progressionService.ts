...
import { GenerationParams } from '../types/music';
...
// Create a progression in Firestore
...
// Request a chord progression generation via Firebase Function
...
// Check if progressions exist for the given parameters
